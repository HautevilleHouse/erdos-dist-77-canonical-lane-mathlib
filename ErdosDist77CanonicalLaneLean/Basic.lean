/-!
# erdos-dist-77 Lean migration boundary
...
`erdos_dist_77/SourcePackage.lean`.
...
def sourceRepository : String := "erdos-dist-77"
def sourceUrl : String := "https://github.com/HautevilleHouse/erdos-dist-77"
def sourceDescription : String := "Canonical-lane closure package for the Erdős Distinct Distances (n=77): admissible-class formulation, projection gates, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["erdos-dist-77", "canonical-lane", "admissible-class", "mathematical-proof", "reproducibility"]
