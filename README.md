# Erdős Distinct Distances (n=77) — Canonical Lane Mathlib

Mathlib-backed Canonical Lane formalization package for the Erdős Distinct Distances (n=77).

## Clean-clone replay

```bash
git clone https://github.com/HautevilleHouse/erdos-dist-77-mathlib.git
cd erdos-dist-77-mathlib
lake exe
lake build
```
